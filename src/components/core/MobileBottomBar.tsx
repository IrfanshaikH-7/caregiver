...
export default function MobileBottomBar() {
    ...
    return (
        <div className="fixed h-[84px] w-full sm:hidden bottom-0 left-0 right-0 bg-secondary border-t border-gray-200 flex items-center safe-area-pb">
            <div className="flex w-full  justify-around items-center max-w-md mx-auto">
                ...
                >
                    ...
                    <span
                        className={`text-xs font-medium ${activeTab === 'home' ? 'text-tertiary' : 'text-gray-500'
                            }`}
                    >
                        Home
                    </span>
                ...
                >
                    ...
                    <span
                        className={`text-xs font-medium ${activeTab === 'profile' ? 'text-tertiary' : 'text-gray-500'
                            }`}
                    >
                        Profile
                    </span>
